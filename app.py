...
app = Flask(__name__)
app.secret_key = 'taskflow-dev-key'
...
def index():
    ...
    tareas_completadas = db_manager.obtener_tareas(estado="Completada")
...
def crear_tarea_web():
    ...
    if request.method == 'POST':
        ...
        flash('La tarea se creó correctamente.', 'success')
...
def completar_tarea_web(tarea_id):
    db_manager.completar_tarea(tarea_id)
    flash('¡Buen trabajo! Tarea completada.', 'success')
    return redirect(url_for('index'))

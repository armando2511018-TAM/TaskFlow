...
class Proyecto:
    ...
    def to_dict(self):
        """Convierte el objeto a un diccionario, útil para Flask y DB."""
        return {
            'id' : self._id,
            'nombre' : self._nombre,
...
class Tarea:
    ...
    def __init__(self, titulo: str, fecha_limite: str, prioridad: str, proyecto_id: int, descripcion: str = "", id: int = None,
